...
public class CardanoExpiredPoolListAction extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
        ...
        if (dialog.showAndGet()) {
            ...
            if (!queryParams.isEmpty()) {
                ...
                fetcher.fetchExpiredPoolList(queryString.toString());
            } else {
        ...
        public Map<String, String> getQueryParameters() {
            ...
            try {
                ...
                if (!limit.isEmpty()) {
                    ...
                    params.put("limit", "20"); // Use default value if limit is empty
                }
