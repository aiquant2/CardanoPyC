...
import static org.intellij.sdk.language.impl.HaskellParserUtil.*;
...
public class HaskellParser implements PsiParser, LightPsiParser {
  ...
  //                                   foreign_declaration | type_family_declaration |function_declaration| deriving_declaration | type_instance_declaration | type_signature |
  ...
  private static boolean top_declaration_0(PsiBuilder b, int l) {
    ...
    if (!r) r = type_family_declaration(b, l + 1);
    if (!r) r = consumeToken(b, HS_FUNCTION_DECLARATION);
